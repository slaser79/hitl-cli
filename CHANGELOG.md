...
- Synchronized version number in flake.nix with pyproject.toml

### Fixed
- Fixed version mismatch between flake.nix and pyproject.toml
...
[1.2.1]: https://github.com/slaser79/hitl-cli/releases/tag/v1.2.1
